...
import { IconEye, IconEyeOff, IconLock, IconRefresh } from '@intentui/icons'
                    ...
                    <div className='mt-3 space-y-3'>
                        {errors?.length ? (
                            ...
                            <>
                                <div
                                    ref={codesSectionRef}
                                    className='grid gap-1 rounded-lg bg-muted py-4 font-mono text-sm'
                                    role='list'
                                    ...
                                    {recoveryCodesList.length ? (
                                        ...
                                        >
                                            {Array.from({ length: 8 }, (_, index) => (
                                                <div
                                                    key={index}
                                                    className='h-4 animate-pulse rounded bg-muted-fg/20'
                                                    aria-hidden='true'
                                                />
                                            ))}
                                        </div>
                                ...
                                <div className='select-none text-muted-fg text-xs'>
