...
function GridScanIcon() {
    return (
        <div className='mb-3 rounded-full border border-border bg-overlay p-0.5 shadow-sm'>
            <div className='relative overflow-hidden rounded-full border border-border bg-muted p-2.5'>
                ...
                <svg
                    className='relative z-20 size-6 text-fg'
...
function TwoFactorSetupStep({
    ...
    const IconComponent = copiedText === manualSetupKey ? IconCheck : IconDuplicate
            ...
            {errors?.length ? (
                ...
                <>
                    ...
                    <div className='relative flex w-full items-center justify-center'>
                        ...
                        <span className='relative bg-overlay px-2 py-1'>
...
export default function TwoFactorSetupModal({
    ...
    return (
        <Modal isOpen={isOpen} onOpenChange={(open) => !open && handleClose()}>
            <ModalTrigger className='sr-only' />
            <ModalContent className='sm:max-w-md'>
                <ModalHeader className='flex flex-col items-center justify-between'>
                    <GridScanIcon />
                    <ModalTitle className='text-center'>{modalConfig.title}</ModalTitle>
                    <ModalDescription className='text-center'>
                        {modalConfig.description}
                    </ModalDescription>
                </ModalHeader>

                <ModalBody className='flex flex-col items-center space-y-5 pb-8'>
