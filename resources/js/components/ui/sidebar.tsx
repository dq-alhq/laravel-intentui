                    ...
                    {badge &&
                        (state !== 'collapsed' ? (
                            <span
                                ...
                                className='absolute inset-e-1.5 inset-ring-1 inset-ring-sidebar-border inset-y-1/2 h-5.5 w-auto -translate-y-1/2 rounded-full bg-fg/5 px-2 text-[10px]/5.5 group-hover/sidebar-item:inset-ring-muted-fg/30 group-current:inset-ring-transparent'
                            >
                                {badge}
                            </span>
                        ) : (
