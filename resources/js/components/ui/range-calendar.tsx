                                ...
                                {(date) => (
                                    <CalendarCell
                                        ...
                                        className={twMerge([
                                            ...
                                            date.compare(now) === 0 &&
                                                'after:pointer-events-none after:absolute after:inset-s-1/2 after:bottom-1 after:z-10 after:size-0.75 after:-translate-x-1/2 after:rounded-full after:bg-primary selected:after:bg-primary-fg',
                                        ])}
                                    >
                                        {({
                                            formattedDate,
