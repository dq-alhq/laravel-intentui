...
export function TabScrollArea({ className, ...props }: React.ComponentProps<'div'>) {
    return (
        <div className='relative'>
            <div
                className={twMerge(
                    'scrollbar-hidden overflow-x-auto sm:overflow-x-visible',
                    className,
                )}
            >
                <div
                    ...
                    {selectionIndicator && (
                        <SelectionIndicator
                            ...
                            className={twMerge(
                                ...
                                orientation === 'horizontal'
                                    ? 'inset-e-(--tab-gutter-x) inset-s-(--tab-gutter-x) -bottom-[calc(var(--tab-gutter-y)+1px)] h-0.5 motion-safe:transition-[translate,width]'
