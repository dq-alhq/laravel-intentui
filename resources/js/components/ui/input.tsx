    ...
    return (
        <span data-slot='control' className='relative block w-full'>
            <InputPrimitive
                ref={ref}
                className={cx(
                    'relative block w-full appearance-none rounded-lg bg-(--control-bg,transparent) px-[calc(--spacing(3.5)-1px)] py-[calc(--spacing(2.5)-1px)] transition sm:px-[calc(--spacing(3)-1px)] sm:py-[calc(--spacing(1.5)-1px)]',
    ...
    return (
        <Group
            ...
            className={cx(
                ...
                '[&>[data-slot=icon]:first-child]:inset-s-3 sm:[&>[data-slot=icon]:first-child]:inset-s-2.5 [&>[data-slot=icon]:last-child]:inset-e-3 sm:[&>[data-slot=icon]:last-child]:inset-e-2.5',
